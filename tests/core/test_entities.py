...
def make_simulation(simulation_builder, tax_benefit_system):
    ...
    def _make_simulation(period, entities):
...
def test_role_index_and_positions(make_simulation, month):
    simulation = make_simulation(month, TEST_CASE)
...
def test_project(make_simulation, year):
    test_case = deepcopy(TEST_CASE)
    test_case['households']['h1']['housing_tax'] = 20000

    simulation = make_simulation(year, test_case)
    household = simulation.household
...
def test_implicit_projection(make_simulation, year):
    test_case = deepcopy(TEST_CASE)
    test_case['households']['h1']['housing_tax'] = 20000
...
def test_sum(make_simulation, month):
    test_case = deepcopy(TEST_CASE)
...
def test_any(make_simulation, month):
...
def test_all(make_simulation, month):
    test_case = deepcopy(TEST_CASE_AGES)
    simulation = make_simulation(month, test_case)
    household = simulation.household
...
def test_max(make_simulation, month):
    test_case = deepcopy(TEST_CASE_AGES)
    simulation = make_simulation(month, test_case)
    household = simulation.household
...
def test_min(make_simulation, month):
    test_case = deepcopy(TEST_CASE_AGES)
    simulation = make_simulation(month, test_case)
    household = simulation.household
...
def test_value_nth_person(make_simulation, month):
    test_case = deepcopy(TEST_CASE_AGES)
    simulation = make_simulation(month, test_case)
    household = simulation.household
...
def test_rank(make_simulation, month):
    test_case = deepcopy(TEST_CASE_AGES)
    simulation = make_simulation(month, test_case)
    person = simulation.person
...
def test_partner(make_simulation, month):
    test_case = deepcopy(TEST_CASE)
    test_case['persons']['ind0']['salary'] = 1000
    test_case['persons']['ind1']['salary'] = 1500
    test_case['persons']['ind4']['salary'] = 3000
...
def test_value_from_first_person(make_simulation, month):
    test_case = deepcopy(TEST_CASE)
    test_case['persons']['ind0']['salary'] = 1000
    test_case['persons']['ind1']['salary'] = 1500
    test_case['persons']['ind4']['salary'] = 3000
...
def test_sum_following_bug_ipp_1(make_simulation, month):
    test_case = {
...
def test_sum_following_bug_ipp_2(make_simulation, month):
    test_case = {
        'persons': {'ind0': {}, 'ind1': {}, 'ind2': {}, 'ind3': {}},
        'households': {
...
def test_unordered_persons(make_simulation, month):
    test_case = {
